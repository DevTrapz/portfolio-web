---
display: true
title: "Building a monday.com app, an item multi-selector with custom bulk actions"
...
team:
  ...
  - name: "Tom Kaufman"
    ...
    linkedIn: "https://www.linkedin.com/in/tom-kaufman-b594268/"
tags:
  - name: React
    icon: react
  - name: TypeScript
...
Development of a monday.com app that enables the selection of mutliple items, to apply bulk actions, that integrate with external data systems.
